...
@Component({
  selector: 'app-pays-rencontre-media-create-admin',
  templateUrl: './pays-rencontre-media-create-admin.component.html',
  styleUrls: ['./pays-rencontre-media-create-admin.component.css']
})
export class PaysRencontreMediaCreateAdminComponent implements OnInit {
