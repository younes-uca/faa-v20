...
@Component({
  selector: 'app-encadrement-etudiant-enjeux-ird-create-admin',
  templateUrl: './encadrement-etudiant-enjeux-ird-create-admin.component.html',
  styleUrls: ['./encadrement-etudiant-enjeux-ird-create-admin.component.css']
})
export class EncadrementEtudiantEnjeuxIrdCreateAdminComponent implements OnInit {
