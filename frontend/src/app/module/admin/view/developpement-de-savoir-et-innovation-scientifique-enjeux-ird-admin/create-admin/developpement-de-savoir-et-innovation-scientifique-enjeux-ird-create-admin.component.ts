...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-enjeux-ird-create-admin',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-enjeux-ird-create-admin.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-enjeux-ird-create-admin.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueEnjeuxIrdCreateAdminComponent implements OnInit {
