...
@Component({
  selector: 'app-outil-pedagogique-pays-conception-create-admin',
  templateUrl: './outil-pedagogique-pays-conception-create-admin.component.html',
  styleUrls: ['./outil-pedagogique-pays-conception-create-admin.component.css']
})
export class OutilPedagogiquePaysConceptionCreateAdminComponent implements OnInit {
