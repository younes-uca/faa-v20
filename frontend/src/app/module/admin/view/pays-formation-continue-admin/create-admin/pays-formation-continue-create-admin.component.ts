...
@Component({
  selector: 'app-pays-formation-continue-create-admin',
  templateUrl: './pays-formation-continue-create-admin.component.html',
  styleUrls: ['./pays-formation-continue-create-admin.component.css']
})
export class PaysFormationContinueCreateAdminComponent implements OnInit {
