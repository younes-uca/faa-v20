...
@Component({
  selector: 'app-responsabilite-pedagogique-enjeux-ird-create-admin',
  templateUrl: './responsabilite-pedagogique-enjeux-ird-create-admin.component.html',
  styleUrls: ['./responsabilite-pedagogique-enjeux-ird-create-admin.component.css']
})
export class ResponsabilitePedagogiqueEnjeuxIrdCreateAdminComponent implements OnInit {
