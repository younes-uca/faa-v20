...
@Component({
  ...
  styleUrls: ['./communaute-savoir-evenement-colloque-scientifique-create-admin.component.css']
})
export class CommunauteSavoirEvenementColloqueScientifiqueCreateAdminComponent implements OnInit {
