...
@Component({
  selector: 'app-comite-et-commission-evaluation-list-admin',
  templateUrl: './comite-et-commission-evaluation-list-admin.component.html',
  styleUrls: ['./comite-et-commission-evaluation-list-admin.component.css']
})
export class ComiteEtCommissionEvaluationListAdminComponent implements OnInit {
   // declarations
