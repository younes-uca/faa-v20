...
@Component({
  selector: 'app-type-publique-rencontre-media-create-admin',
  templateUrl: './type-publique-rencontre-media-create-admin.component.html',
  styleUrls: ['./type-publique-rencontre-media-create-admin.component.css']
})
export class TypePubliqueRencontreMediaCreateAdminComponent implements OnInit {
