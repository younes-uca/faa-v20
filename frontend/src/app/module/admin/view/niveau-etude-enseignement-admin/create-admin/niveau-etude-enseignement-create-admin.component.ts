...
@Component({
  selector: 'app-niveau-etude-enseignement-create-admin',
  templateUrl: './niveau-etude-enseignement-create-admin.component.html',
  styleUrls: ['./niveau-etude-enseignement-create-admin.component.css']
})
export class NiveauEtudeEnseignementCreateAdminComponent implements OnInit {
