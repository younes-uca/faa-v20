...
@Component({
  selector: 'app-discipline-scientifique-conseils-scientifique-create-admin',
  templateUrl: './discipline-scientifique-conseils-scientifique-create-admin.component.html',
  styleUrls: ['./discipline-scientifique-conseils-scientifique-create-admin.component.css']
})
export class DisciplineScientifiqueConseilsScientifiqueCreateAdminComponent implements OnInit {
