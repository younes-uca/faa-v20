...
@Component({
  ...
  styleUrls: ['./zone-activite-interaction-recherche-create-admin.component.css']
})
export class ZoneActiviteInteractionRechercheCreateAdminComponent implements OnInit {
