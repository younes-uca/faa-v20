...
@Component({
  selector: 'app-type-instrument-ird-consultance-scientifique-ponctuelle-create-admin',
  templateUrl: './type-instrument-ird-consultance-scientifique-ponctuelle-create-admin.component.html',
  styleUrls: ['./type-instrument-ird-consultance-scientifique-ponctuelle-create-admin.component.css']
})
export class TypeInstrumentIrdConsultanceScientifiquePonctuelleCreateAdminComponent implements OnInit {
