...
@Component({
  selector: 'app-formation-continue-discipline-scientifique-create-admin',
  templateUrl: './formation-continue-discipline-scientifique-create-admin.component.html',
  styleUrls: ['./formation-continue-discipline-scientifique-create-admin.component.css']
})
export class FormationContinueDisciplineScientifiqueCreateAdminComponent implements OnInit {
