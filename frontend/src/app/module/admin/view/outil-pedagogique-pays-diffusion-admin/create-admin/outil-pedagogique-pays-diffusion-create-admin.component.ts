...
@Component({
  selector: 'app-outil-pedagogique-pays-diffusion-create-admin',
  templateUrl: './outil-pedagogique-pays-diffusion-create-admin.component.html',
  styleUrls: ['./outil-pedagogique-pays-diffusion-create-admin.component.css']
})
export class OutilPedagogiquePaysDiffusionCreateAdminComponent implements OnInit {
