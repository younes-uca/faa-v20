...
@Component({
  selector: 'app-pays-rencontre-grand-publique-jeune-publique-create-admin',
  templateUrl: './pays-rencontre-grand-publique-jeune-publique-create-admin.component.html',
  styleUrls: ['./pays-rencontre-grand-publique-jeune-publique-create-admin.component.css']
})
export class PaysRencontreGrandPubliqueJeunePubliqueCreateAdminComponent implements OnInit {
