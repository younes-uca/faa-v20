...
@Component({
  selector: 'app-vie-institutionnelle-detail-etablissement-create-admin',
  templateUrl: './vie-institutionnelle-detail-etablissement-create-admin.component.html',
  styleUrls: ['./vie-institutionnelle-detail-etablissement-create-admin.component.css']
})
export class VieInstitutionnelleDetailEtablissementCreateAdminComponent implements OnInit {
