...
@Component({
  selector: 'app-objet-formation-generique-de-responsabilite-pedagogique-create-admin',
  templateUrl: './objet-formation-generique-de-responsabilite-pedagogique-create-admin.component.html',
  styleUrls: ['./objet-formation-generique-de-responsabilite-pedagogique-create-admin.component.css']
})
export class ObjetFormationGeneriqueDeResponsabilitePedagogiqueCreateAdminComponent implements OnInit {
