...
@Component({
  selector: 'app-etablissement-enseignement-create-admin',
  templateUrl: './etablissement-enseignement-create-admin.component.html',
  styleUrls: ['./etablissement-enseignement-create-admin.component.css']
})
export class EtablissementEnseignementCreateAdminComponent implements OnInit {
