...
@Component({
  selector: 'app-enseignement-discipline-scientifique-create-admin',
  templateUrl: './enseignement-discipline-scientifique-create-admin.component.html',
  styleUrls: ['./enseignement-discipline-scientifique-create-admin.component.css']
})
export class EnseignementDisciplineScientifiqueCreateAdminComponent implements OnInit {
