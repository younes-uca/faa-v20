...
@Component({
  selector: 'app-responsabilite-pedagogique-etablissement-create-admin',
  templateUrl: './responsabilite-pedagogique-etablissement-create-admin.component.html',
  styleUrls: ['./responsabilite-pedagogique-etablissement-create-admin.component.css']
})
export class ResponsabilitePedagogiqueEtablissementCreateAdminComponent implements OnInit {
