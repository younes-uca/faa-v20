...
@Component({
  selector: 'app-enseignement-nature-create-admin',
  templateUrl: './enseignement-nature-create-admin.component.html',
  styleUrls: ['./enseignement-nature-create-admin.component.css']
})
export class EnseignementNatureCreateAdminComponent implements OnInit {
