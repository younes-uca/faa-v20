...
@Component({
  selector: 'app-campagne-relance-chercheur-create-admin',
  templateUrl: './campagne-relance-chercheur-create-admin.component.html',
  styleUrls: ['./campagne-relance-chercheur-create-admin.component.css']
})
export class CampagneRelanceChercheurCreateAdminComponent implements OnInit {
