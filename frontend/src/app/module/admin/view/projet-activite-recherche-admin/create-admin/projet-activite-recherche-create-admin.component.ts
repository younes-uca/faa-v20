...
@Component({
  selector: 'app-projet-activite-recherche-create-admin',
  templateUrl: './projet-activite-recherche-create-admin.component.html',
  styleUrls: ['./projet-activite-recherche-create-admin.component.css']
})
export class ProjetActiviteRechercheCreateAdminComponent implements OnInit {
