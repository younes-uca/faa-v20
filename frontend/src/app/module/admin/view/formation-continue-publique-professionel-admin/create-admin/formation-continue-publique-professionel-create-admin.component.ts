...
@Component({
  ...
  styleUrls: ['./formation-continue-publique-professionel-create-admin.component.css']
})
export class FormationContinuePubliqueProfessionelCreateAdminComponent implements OnInit {
