...
@Component({
  selector: 'app-pays-organisateur-rencontre-grand-publique-jeune-publique-create-admin',
  templateUrl: './pays-organisateur-rencontre-grand-publique-jeune-publique-create-admin.component.html',
  styleUrls: ['./pays-organisateur-rencontre-grand-publique-jeune-publique-create-admin.component.css']
})
export class PaysOrganisateurRencontreGrandPubliqueJeunePubliqueCreateAdminComponent implements OnInit {
