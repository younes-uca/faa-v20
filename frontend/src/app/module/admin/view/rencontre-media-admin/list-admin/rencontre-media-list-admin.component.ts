...
@Component({
  selector: 'app-rencontre-media-list-admin',
  templateUrl: './rencontre-media-list-admin.component.html',
  styleUrls: ['./rencontre-media-list-admin.component.css']
})
export class RencontreMediaListAdminComponent implements OnInit {
   // declarations
