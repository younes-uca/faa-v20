...
@Component({
  ...
  styleUrls: ['./discipline-scientifique-chercheur-create-admin.component.css']
})
export class DisciplineScientifiqueChercheurCreateAdminComponent implements OnInit {
