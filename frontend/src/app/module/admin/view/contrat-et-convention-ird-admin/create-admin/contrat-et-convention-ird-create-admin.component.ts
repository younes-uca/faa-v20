...
@Component({
  selector: 'app-contrat-et-convention-ird-create-admin',
  templateUrl: './contrat-et-convention-ird-create-admin.component.html',
  styleUrls: ['./contrat-et-convention-ird-create-admin.component.css']
})
export class ContratEtConventionIrdCreateAdminComponent implements OnInit {
