...
@Component({
  selector: 'app-formation-continue-commanditaire-create-admin',
  templateUrl: './formation-continue-commanditaire-create-admin.component.html',
  styleUrls: ['./formation-continue-commanditaire-create-admin.component.css']
})
export class FormationContinueCommanditaireCreateAdminComponent implements OnInit {
