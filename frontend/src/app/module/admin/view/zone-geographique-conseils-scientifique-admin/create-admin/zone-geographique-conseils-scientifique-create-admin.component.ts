...
@Component({
  selector: 'app-zone-geographique-conseils-scientifique-create-admin',
  templateUrl: './zone-geographique-conseils-scientifique-create-admin.component.html',
  styleUrls: ['./zone-geographique-conseils-scientifique-create-admin.component.css']
})
export class ZoneGeographiqueConseilsScientifiqueCreateAdminComponent implements OnInit {
