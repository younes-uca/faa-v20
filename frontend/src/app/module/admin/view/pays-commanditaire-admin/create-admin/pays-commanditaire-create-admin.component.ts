...
@Component({
  selector: 'app-pays-commanditaire-create-admin',
  templateUrl: './pays-commanditaire-create-admin.component.html',
  styleUrls: ['./pays-commanditaire-create-admin.component.css']
})
export class PaysCommanditaireCreateAdminComponent implements OnInit {
