...
@Component({
  ...
  styleUrls: ['./formation-continue-objet-formation-generique-create-admin.component.css']
})
export class FormationContinueObjetFormationGeneriqueCreateAdminComponent implements OnInit {
