...
@Component({
  selector: 'app-etablissement-consultance-scientifique-ponctuelle-create-admin',
  templateUrl: './etablissement-consultance-scientifique-ponctuelle-create-admin.component.html',
  styleUrls: ['./etablissement-consultance-scientifique-ponctuelle-create-admin.component.css']
})
export class EtablissementConsultanceScientifiquePonctuelleCreateAdminComponent implements OnInit {
