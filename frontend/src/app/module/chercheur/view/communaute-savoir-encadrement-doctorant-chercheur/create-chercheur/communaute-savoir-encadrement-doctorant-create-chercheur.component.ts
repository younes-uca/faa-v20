...
@Component({
  selector: 'app-communaute-savoir-encadrement-doctorant-create-chercheur',
  templateUrl: './communaute-savoir-encadrement-doctorant-create-chercheur.component.html',
  styleUrls: ['./communaute-savoir-encadrement-doctorant-create-chercheur.component.css']
})
export class CommunauteSavoirEncadrementDoctorantCreateChercheurComponent implements OnInit {
