...
@Component({
  selector: 'app-etablissement-conseils-scientifique-create-chercheur',
  templateUrl: './etablissement-conseils-scientifique-create-chercheur.component.html',
  styleUrls: ['./etablissement-conseils-scientifique-create-chercheur.component.css']
})
export class EtablissementConseilsScientifiqueCreateChercheurComponent implements OnInit {
