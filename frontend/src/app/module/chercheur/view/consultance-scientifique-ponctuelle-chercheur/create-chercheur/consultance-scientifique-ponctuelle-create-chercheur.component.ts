...
@Component({
  selector: 'app-consultance-scientifique-ponctuelle-create-chercheur',
  templateUrl: './consultance-scientifique-ponctuelle-create-chercheur.component.html',
  styleUrls: ['./consultance-scientifique-ponctuelle-create-chercheur.component.css']
})
export class ConsultanceScientifiquePonctuelleCreateChercheurComponent implements OnInit {
