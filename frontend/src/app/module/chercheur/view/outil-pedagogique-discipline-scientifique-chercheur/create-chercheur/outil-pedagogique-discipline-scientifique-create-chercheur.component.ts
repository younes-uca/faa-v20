...
@Component({
  selector: 'app-outil-pedagogique-discipline-scientifique-create-chercheur',
  templateUrl: './outil-pedagogique-discipline-scientifique-create-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-discipline-scientifique-create-chercheur.component.css']
})
export class OutilPedagogiqueDisciplineScientifiqueCreateChercheurComponent implements OnInit {
