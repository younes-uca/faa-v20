...
@Component({
  selector: 'app-instrument-ird-comite-et-commission-evaluation-create-chercheur',
  templateUrl: './instrument-ird-comite-et-commission-evaluation-create-chercheur.component.html',
  styleUrls: ['./instrument-ird-comite-et-commission-evaluation-create-chercheur.component.css']
})
export class InstrumentIrdComiteEtCommissionEvaluationCreateChercheurComponent implements OnInit {
