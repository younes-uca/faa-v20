...
@Component({
  selector: 'app-type-expertise-evaluation-comite-et-commission-evaluation-create-chercheur',
  templateUrl: './type-expertise-evaluation-comite-et-commission-evaluation-create-chercheur.component.html',
  styleUrls: ['./type-expertise-evaluation-comite-et-commission-evaluation-create-chercheur.component.css']
})
export class TypeExpertiseEvaluationComiteEtCommissionEvaluationCreateChercheurComponent implements OnInit {
