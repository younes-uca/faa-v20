...
@Component({
  ...
  styleUrls: ['./distinction-etablissement-pays-create-chercheur.component.css']
})
export class DistinctionEtablissementPaysCreateChercheurComponent implements OnInit {
