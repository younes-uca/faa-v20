...
@Component({
  selector: 'app-projet-activite-recherche-detail-enjeux-ird-create-chercheur',
  templateUrl: './projet-activite-recherche-detail-enjeux-ird-create-chercheur.component.html',
  styleUrls: ['./projet-activite-recherche-detail-enjeux-ird-create-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailEnjeuxIrdCreateChercheurComponent implements OnInit {
