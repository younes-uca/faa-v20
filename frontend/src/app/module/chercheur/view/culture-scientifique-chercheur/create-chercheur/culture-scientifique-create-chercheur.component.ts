...
@Component({
  selector: 'app-culture-scientifique-create-chercheur',
  templateUrl: './culture-scientifique-create-chercheur.component.html',
  styleUrls: ['./culture-scientifique-create-chercheur.component.css']
})
export class CultureScientifiqueCreateChercheurComponent implements OnInit {
 ...
 public loadCampagne(username) {
    this.campagneService.findProgressCampagneByChercheurUsername(username).subscribe(data => {
     if (data != null && data.id != null) {
        let campagneVo = data;
        this.cultureScientifiqueService.findByChercheurUsernameAndCampagneId(this.tokenService.getUsername(), campagneVo['id']).subscribe(cultureScientifique => {
          this.isLoaded = false;
          if (cultureScientifique) {
            this.msgsContents = 'Vous avez saisi les données cultureScientifique de cette campagne';
            this.info = 'info'
            //this.selectedCultureScientifique={ ...cultureScientifique }['0']; TODO: in case non formulaire
            this.selectedCultureScientifique.campagneVo=campagneVo;
            this.isLoaded = true;
          }
          else {
...
if(this.data) {
 this.selectedCultureScientifique=this.data;
 }
