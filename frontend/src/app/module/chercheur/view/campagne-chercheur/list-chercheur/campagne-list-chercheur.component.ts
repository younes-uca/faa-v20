...
@Component({
  selector: 'app-campagne-list-chercheur',
  templateUrl: './campagne-list-chercheur.component.html',
  styleUrls: ['./campagne-list-chercheur.component.css']
})
export class CampagneListChercheurComponent implements OnInit {
   // declarations
