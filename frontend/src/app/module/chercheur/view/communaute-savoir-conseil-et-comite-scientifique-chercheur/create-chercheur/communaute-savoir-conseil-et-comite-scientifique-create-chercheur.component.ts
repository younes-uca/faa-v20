...
@Component({
  selector: 'app-communaute-savoir-conseil-et-comite-scientifique-create-chercheur',
  templateUrl: './communaute-savoir-conseil-et-comite-scientifique-create-chercheur.component.html',
  styleUrls: ['./communaute-savoir-conseil-et-comite-scientifique-create-chercheur.component.css']
})
export class CommunauteSavoirConseilEtComiteScientifiqueCreateChercheurComponent implements OnInit {
