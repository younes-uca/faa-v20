...
@Component({
  selector: 'app-etablissement-comite-et-commission-evaluation-create-chercheur',
  templateUrl: './etablissement-comite-et-commission-evaluation-create-chercheur.component.html',
  styleUrls: ['./etablissement-comite-et-commission-evaluation-create-chercheur.component.css']
})
export class EtablissementComiteEtCommissionEvaluationCreateChercheurComponent implements OnInit {
