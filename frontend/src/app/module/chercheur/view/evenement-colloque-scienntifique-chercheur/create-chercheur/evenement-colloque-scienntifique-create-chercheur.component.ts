...
@Component({
  selector: 'app-evenement-colloque-scienntifique-create-chercheur',
  templateUrl: './evenement-colloque-scienntifique-create-chercheur.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-create-chercheur.component.css']
})
export class EvenementColloqueScienntifiqueCreateChercheurComponent implements OnInit {
