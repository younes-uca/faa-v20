...
@Component({
  ...
  styleUrls: ['./enseignement-zone-geographique-create-chercheur.component.css']
})
export class EnseignementZoneGeographiqueCreateChercheurComponent implements OnInit {
