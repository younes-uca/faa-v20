...
@Component({
  ...
  styleUrls: ['./projet-activite-recherche-detail-instrument-ird-create-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailInstrumentIrdCreateChercheurComponent implements OnInit {
