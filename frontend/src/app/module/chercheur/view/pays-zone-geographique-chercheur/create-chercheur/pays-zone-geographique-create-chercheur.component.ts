...
@Component({
  selector: 'app-pays-zone-geographique-create-chercheur',
  templateUrl: './pays-zone-geographique-create-chercheur.component.html',
  styleUrls: ['./pays-zone-geographique-create-chercheur.component.css']
})
export class PaysZoneGeographiqueCreateChercheurComponent implements OnInit {
