...
@Component({
  selector: 'app-evenement-colloque-scienntifique-enjeux-ird-create-chercheur',
  templateUrl: './evenement-colloque-scienntifique-enjeux-ird-create-chercheur.component.html',
  styleUrls: ['./evenement-colloque-scienntifique-enjeux-ird-create-chercheur.component.css']
})
export class EvenementColloqueScienntifiqueEnjeuxIrdCreateChercheurComponent implements OnInit {
