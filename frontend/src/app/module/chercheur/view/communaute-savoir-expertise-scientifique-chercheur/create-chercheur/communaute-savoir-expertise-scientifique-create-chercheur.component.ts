...
@Component({
  selector: 'app-communaute-savoir-expertise-scientifique-create-chercheur',
  templateUrl: './communaute-savoir-expertise-scientifique-create-chercheur.component.html',
  styleUrls: ['./communaute-savoir-expertise-scientifique-create-chercheur.component.css']
})
export class CommunauteSavoirExpertiseScientifiqueCreateChercheurComponent implements OnInit {
