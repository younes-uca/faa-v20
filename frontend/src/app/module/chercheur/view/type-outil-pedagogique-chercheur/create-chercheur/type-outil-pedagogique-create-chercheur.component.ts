...
@Component({
  selector: 'app-type-outil-pedagogique-create-chercheur',
  templateUrl: './type-outil-pedagogique-create-chercheur.component.html',
  styleUrls: ['./type-outil-pedagogique-create-chercheur.component.css']
})
export class TypeOutilPedagogiqueCreateChercheurComponent implements OnInit {
