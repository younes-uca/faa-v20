...
@Component({
  selector: 'app-outil-pedagogique-enjeux-ird-create-chercheur',
  templateUrl: './outil-pedagogique-enjeux-ird-create-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-enjeux-ird-create-chercheur.component.css']
})
export class OutilPedagogiqueEnjeuxIrdCreateChercheurComponent implements OnInit {
