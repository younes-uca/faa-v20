...
@Component({
  selector: 'app-encadrement-doctorant-create-chercheur',
  templateUrl: './encadrement-doctorant-create-chercheur.component.html',
  styleUrls: ['./encadrement-doctorant-create-chercheur.component.css']
})
export class EncadrementDoctorantCreateChercheurComponent implements OnInit {
