...
@Component({
  selector: 'app-expertise-scientifique-create-chercheur',
  templateUrl: './expertise-scientifique-create-chercheur.component.html',
  styleUrls: ['./expertise-scientifique-create-chercheur.component.css']
})
export class ExpertiseScientifiqueCreateChercheurComponent implements OnInit {
 ...
 public loadCampagne(username) {
    this.campagneService.findProgressCampagneByChercheurUsername(username).subscribe(data => {
     if (data != null && data.id != null) {
        let campagneVo = data;
        this.expertiseScientifiqueService.findByChercheurUsernameAndCampagneId(this.tokenService.getUsername(), campagneVo['id']).subscribe(expertiseScientifique => {
          this.isLoaded = false;
          if (expertiseScientifique) {
            this.msgsContents = 'Vous avez saisi les données expertiseScientifique de cette campagne';
            this.info = 'info'
            //this.selectedExpertiseScientifique={ ...expertiseScientifique }['0']; TODO: in case non formulaire
            this.selectedExpertiseScientifique.campagneVo=campagneVo;
            this.isLoaded = true;
          }
          else {
...
if(this.data) {
 this.selectedExpertiseScientifique=this.data;
 }
