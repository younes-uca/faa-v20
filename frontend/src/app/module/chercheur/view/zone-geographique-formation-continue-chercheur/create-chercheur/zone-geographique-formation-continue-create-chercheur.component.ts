...
@Component({
  selector: 'app-zone-geographique-formation-continue-create-chercheur',
  templateUrl: './zone-geographique-formation-continue-create-chercheur.component.html',
  styleUrls: ['./zone-geographique-formation-continue-create-chercheur.component.css']
})
export class ZoneGeographiqueFormationContinueCreateChercheurComponent implements OnInit {
