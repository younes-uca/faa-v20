...
@Component({
  ...
  styleUrls: ['./zone-geographique-consultance-scientifique-ponctuelle-create-chercheur.component.css']
})
export class ZoneGeographiqueConsultanceScientifiquePonctuelleCreateChercheurComponent implements OnInit {
