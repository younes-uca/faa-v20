...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-create-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-create-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-create-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueCreateChercheurComponent implements OnInit {
