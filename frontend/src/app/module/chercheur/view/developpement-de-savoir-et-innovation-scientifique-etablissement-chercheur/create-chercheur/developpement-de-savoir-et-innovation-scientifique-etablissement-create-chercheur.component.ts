...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-etablissement-create-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-etablissement-create-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-etablissement-create-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueEtablissementCreateChercheurComponent implements OnInit {
