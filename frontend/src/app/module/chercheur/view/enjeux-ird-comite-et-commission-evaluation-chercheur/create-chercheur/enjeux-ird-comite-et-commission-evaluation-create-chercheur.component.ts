...
@Component({
  selector: 'app-enjeux-ird-comite-et-commission-evaluation-create-chercheur',
  templateUrl: './enjeux-ird-comite-et-commission-evaluation-create-chercheur.component.html',
  styleUrls: ['./enjeux-ird-comite-et-commission-evaluation-create-chercheur.component.css']
})
export class EnjeuxIrdComiteEtCommissionEvaluationCreateChercheurComponent implements OnInit {
