...
@Component({
  ...
  styleUrls: ['./responsabilite-pedagogique-pays-create-chercheur.component.css']
})
export class ResponsabilitePedagogiquePaysCreateChercheurComponent implements OnInit {
