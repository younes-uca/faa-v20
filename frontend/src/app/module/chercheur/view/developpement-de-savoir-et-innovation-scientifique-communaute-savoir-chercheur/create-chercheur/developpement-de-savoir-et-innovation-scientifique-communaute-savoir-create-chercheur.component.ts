...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-communaute-savoir-create-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-communaute-savoir-create-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-communaute-savoir-create-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueCommunauteSavoirCreateChercheurComponent implements OnInit {
