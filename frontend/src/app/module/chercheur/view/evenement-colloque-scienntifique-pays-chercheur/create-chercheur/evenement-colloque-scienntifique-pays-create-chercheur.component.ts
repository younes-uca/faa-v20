...
@Component({
  ...
  styleUrls: ['./evenement-colloque-scienntifique-pays-create-chercheur.component.css']
})
export class EvenementColloqueScienntifiquePaysCreateChercheurComponent implements OnInit {
