...
@Component({
  selector: 'app-outil-pedagogique-list-chercheur',
  templateUrl: './outil-pedagogique-list-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-list-chercheur.component.css']
})
export class OutilPedagogiqueListChercheurComponent implements OnInit {
   // declarations
