...
@Component({
  selector: 'app-developpement-de-savoir-et-innovation-scientifique-discipline-scientifique-create-chercheur',
  templateUrl: './developpement-de-savoir-et-innovation-scientifique-discipline-scientifique-create-chercheur.component.html',
  styleUrls: ['./developpement-de-savoir-et-innovation-scientifique-discipline-scientifique-create-chercheur.component.css']
})
export class DeveloppementDeSavoirEtInnovationScientifiqueDisciplineScientifiqueCreateChercheurComponent implements OnInit {
