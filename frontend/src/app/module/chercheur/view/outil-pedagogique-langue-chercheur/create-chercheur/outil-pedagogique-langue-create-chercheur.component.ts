...
@Component({
  selector: 'app-outil-pedagogique-langue-create-chercheur',
  templateUrl: './outil-pedagogique-langue-create-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-langue-create-chercheur.component.css']
})
export class OutilPedagogiqueLangueCreateChercheurComponent implements OnInit {
