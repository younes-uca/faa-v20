...
@Component({
  selector: 'app-outil-pedagogique-type-instrument-ird-create-chercheur',
  templateUrl: './outil-pedagogique-type-instrument-ird-create-chercheur.component.html',
  styleUrls: ['./outil-pedagogique-type-instrument-ird-create-chercheur.component.css']
})
export class OutilPedagogiqueTypeInstrumentIrdCreateChercheurComponent implements OnInit {
...
public saveWithShowOption(showList: boolean){
     this.outilPedagogiqueTypeInstrumentIrdService.save().subscribe(outilPedagogiqueTypeInstrumentIrd=>{
       this.outilPedagogiqueTypeInstrumentIrds.push({...outilPedagogiqueTypeInstrumentIrd});
       this.createOutilPedagogiqueTypeInstrumentIrdDialog = false;
