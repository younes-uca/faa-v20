...
@Component({
  selector: 'app-conseil-et-comite-scientifique-create-chercheur',
  templateUrl: './conseil-et-comite-scientifique-create-chercheur.component.html',
  styleUrls: ['./conseil-et-comite-scientifique-create-chercheur.component.css']
})
export class ConseilEtComiteScientifiqueCreateChercheurComponent implements OnInit {
