...
@Component({
  selector: 'app-enjeux-ird-conseils-scientifique-create-chercheur',
  templateUrl: './enjeux-ird-conseils-scientifique-create-chercheur.component.html',
  styleUrls: ['./enjeux-ird-conseils-scientifique-create-chercheur.component.css']
})
export class EnjeuxIrdConseilsScientifiqueCreateChercheurComponent implements OnInit {
