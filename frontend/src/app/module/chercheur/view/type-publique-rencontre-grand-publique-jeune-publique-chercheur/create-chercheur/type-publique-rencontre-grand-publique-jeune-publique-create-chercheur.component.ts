...
@Component({
  selector: 'app-type-publique-rencontre-grand-publique-jeune-publique-create-chercheur',
  templateUrl: './type-publique-rencontre-grand-publique-jeune-publique-create-chercheur.component.html',
  styleUrls: ['./type-publique-rencontre-grand-publique-jeune-publique-create-chercheur.component.css']
})
export class TypePubliqueRencontreGrandPubliqueJeunePubliqueCreateChercheurComponent implements OnInit {
