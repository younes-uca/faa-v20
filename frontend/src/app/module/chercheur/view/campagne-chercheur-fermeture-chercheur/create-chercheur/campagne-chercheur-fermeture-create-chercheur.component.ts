...
@Component({
  selector: 'app-campagne-chercheur-fermeture-create-chercheur',
  templateUrl: './campagne-chercheur-fermeture-create-chercheur.component.html',
  styleUrls: ['./campagne-chercheur-fermeture-create-chercheur.component.css']
})
export class CampagneChercheurFermetureCreateChercheurComponent implements OnInit {
