...
@Component({
  selector: 'app-enjeux-ird-encadrement-doctorant-create-chercheur',
  templateUrl: './enjeux-ird-encadrement-doctorant-create-chercheur.component.html',
  styleUrls: ['./enjeux-ird-encadrement-doctorant-create-chercheur.component.css']
})
export class EnjeuxIrdEncadrementDoctorantCreateChercheurComponent implements OnInit {
