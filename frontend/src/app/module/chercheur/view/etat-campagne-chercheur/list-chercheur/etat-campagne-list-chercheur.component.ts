...
@Component({
  selector: 'app-etat-campagne-list-chercheur',
  templateUrl: './etat-campagne-list-chercheur.component.html',
  styleUrls: ['./etat-campagne-list-chercheur.component.css']
})
export class EtatCampagneListChercheurComponent implements OnInit {
   // declarations
