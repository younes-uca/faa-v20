...
@Component({
  selector: 'app-etat-campagne-create-chercheur',
  templateUrl: './etat-campagne-create-chercheur.component.html',
  styleUrls: ['./etat-campagne-create-chercheur.component.css']
})
export class EtatCampagneCreateChercheurComponent implements OnInit {
