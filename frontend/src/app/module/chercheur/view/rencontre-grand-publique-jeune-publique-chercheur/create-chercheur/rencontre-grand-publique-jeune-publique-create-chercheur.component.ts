...
@Component({
  ...
  styleUrls: ['./rencontre-grand-publique-jeune-publique-create-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueCreateChercheurComponent implements OnInit {
