...
@Component({
  ...
  styleUrls: ['./projet-activite-recherche-detail-create-chercheur.component.css']
})
export class ProjetActiviteRechercheDetailCreateChercheurComponent implements OnInit {
