...
@Component({
  ...
  styleUrls: ['./formation-continue-enjeux-ird-create-chercheur.component.css']
})
export class FormationContinueEnjeuxIrdCreateChercheurComponent implements OnInit {
