...
@Component({
  selector: 'app-discipline-scientifique-consultance-scientifique-ponctuelle-create-chercheur',
  templateUrl: './discipline-scientifique-consultance-scientifique-ponctuelle-create-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-consultance-scientifique-ponctuelle-create-chercheur.component.css']
})
export class DisciplineScientifiqueConsultanceScientifiquePonctuelleCreateChercheurComponent implements OnInit {
