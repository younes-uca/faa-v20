...
@Component({
  ...
  styleUrls: ['./rencontre-grand-publique-jeune-publique-type-instrument-ird-create-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueTypeInstrumentIrdCreateChercheurComponent implements OnInit {
