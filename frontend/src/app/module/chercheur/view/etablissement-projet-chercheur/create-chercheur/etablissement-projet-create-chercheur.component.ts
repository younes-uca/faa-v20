...
@Component({
  selector: 'app-etablissement-projet-create-chercheur',
  templateUrl: './etablissement-projet-create-chercheur.component.html',
  styleUrls: ['./etablissement-projet-create-chercheur.component.css']
})
export class EtablissementProjetCreateChercheurComponent implements OnInit {
