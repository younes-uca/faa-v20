...
@Component({
  selector: 'app-communaute-savoir-encadrement-etudiant-create-chercheur',
  templateUrl: './communaute-savoir-encadrement-etudiant-create-chercheur.component.html',
  styleUrls: ['./communaute-savoir-encadrement-etudiant-create-chercheur.component.css']
})
export class CommunauteSavoirEncadrementEtudiantCreateChercheurComponent implements OnInit {
