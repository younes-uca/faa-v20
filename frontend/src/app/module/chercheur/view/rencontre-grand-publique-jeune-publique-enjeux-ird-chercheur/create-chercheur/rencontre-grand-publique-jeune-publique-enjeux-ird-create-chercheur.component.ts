...
@Component({
  selector: 'app-rencontre-grand-publique-jeune-publique-enjeux-ird-create-chercheur',
  templateUrl: './rencontre-grand-publique-jeune-publique-enjeux-ird-create-chercheur.component.html',
  styleUrls: ['./rencontre-grand-publique-jeune-publique-enjeux-ird-create-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueEnjeuxIrdCreateChercheurComponent implements OnInit {
