...
@Component({
  ...
  styleUrls: ['./rencontre-grand-publique-jeune-publique-discipline-scientifique-create-chercheur.component.css']
})
export class RencontreGrandPubliqueJeunePubliqueDisciplineScientifiqueCreateChercheurComponent implements OnInit {
