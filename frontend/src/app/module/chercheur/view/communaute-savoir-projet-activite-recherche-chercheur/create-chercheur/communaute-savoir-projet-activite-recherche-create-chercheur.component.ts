...
@Component({
  selector: 'app-communaute-savoir-projet-activite-recherche-create-chercheur',
  templateUrl: './communaute-savoir-projet-activite-recherche-create-chercheur.component.html',
  styleUrls: ['./communaute-savoir-projet-activite-recherche-create-chercheur.component.css']
})
export class CommunauteSavoirProjetActiviteRechercheCreateChercheurComponent implements OnInit {
