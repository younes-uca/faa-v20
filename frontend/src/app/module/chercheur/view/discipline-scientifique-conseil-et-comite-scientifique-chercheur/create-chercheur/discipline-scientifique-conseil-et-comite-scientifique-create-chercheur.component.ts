...
@Component({
  ...
  styleUrls: ['./discipline-scientifique-conseil-et-comite-scientifique-create-chercheur.component.css']
})
export class DisciplineScientifiqueConseilEtComiteScientifiqueCreateChercheurComponent implements OnInit {
