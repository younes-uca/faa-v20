...
@Component({
  selector: 'app-discipline-scientifique-encadrement-doctorant-create-chercheur',
  templateUrl: './discipline-scientifique-encadrement-doctorant-create-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-encadrement-doctorant-create-chercheur.component.css']
})
export class DisciplineScientifiqueEncadrementDoctorantCreateChercheurComponent implements OnInit {
