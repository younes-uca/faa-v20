...
private StatusProjetConverter statusProjetConverter;
    ...
    public List<StatusProjetVo> findByCriteria(@RequestBody StatusProjetVo statusProjetVo){
        return statusProjetConverter.toVo(statusProjetService.findByCriteria(statusProjetVo));
            ...
            @PutMapping("/archiver/")
            public StatusProjetVo archiver(@RequestBody StatusProjetVo statusProjetVo){
                StatusProjet statusProjet = statusProjetService.archiver(statusProjetConverter.toItem(statusProjetVo));
                return statusProjetConverter.toVo(statusProjet);
                }

            @PutMapping("/desarchiver/")
            public StatusProjetVo desarchiver(@RequestBody StatusProjetVo statusProjetVo){
                StatusProjet statusProjet = statusProjetService.desarchiver(statusProjetConverter.toItem(statusProjetVo));
                return statusProjetConverter.toVo(statusProjet);}
            }
