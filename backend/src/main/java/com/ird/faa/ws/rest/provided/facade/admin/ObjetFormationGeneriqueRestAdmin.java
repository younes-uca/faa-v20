...
@RestController
@RequestMapping("api/admin/objetFormationGenerique")
public class ObjetFormationGeneriqueRestAdmin {
...
private ObjetFormationGeneriqueConverter objetFormationGeneriqueConverter;
    ...
    public List<ObjetFormationGeneriqueVo> findByCriteria(@RequestBody ObjetFormationGeneriqueVo objetFormationGeneriqueVo){
        return objetFormationGeneriqueConverter.toVo(objetFormationGeneriqueService.findByCriteria(objetFormationGeneriqueVo));
            ...
            @PutMapping("/archiver/")
            public ObjetFormationGeneriqueVo archiver(@RequestBody ObjetFormationGeneriqueVo objetFormationGeneriqueVo){
                ObjetFormationGenerique objetFormationGenerique = objetFormationGeneriqueService.archiver(objetFormationGeneriqueConverter.toItem(objetFormationGeneriqueVo));
                return objetFormationGeneriqueConverter.toVo(objetFormationGenerique);
                }

            @PutMapping("/desarchiver/")
            public ObjetFormationGeneriqueVo desarchiver(@RequestBody ObjetFormationGeneriqueVo objetFormationGeneriqueVo){
                ObjetFormationGenerique objetFormationGenerique = objetFormationGeneriqueService.desarchiver(objetFormationGeneriqueConverter.toItem(objetFormationGeneriqueVo));
                return objetFormationGeneriqueConverter.toVo(objetFormationGenerique);}
            }
