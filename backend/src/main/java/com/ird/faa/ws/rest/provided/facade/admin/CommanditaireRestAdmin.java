...
@RestController
@RequestMapping("api/admin/commanditaire")
public class CommanditaireRestAdmin {
...
private CommanditaireConverter commanditaireConverter;
    ...
    public List<CommanditaireVo> findByCriteria(@RequestBody CommanditaireVo commanditaireVo){
        ...
        return commanditaireService.deleteByPaysId(id);
            ...
            @PutMapping("/archiver/")
            public CommanditaireVo archiver(@RequestBody CommanditaireVo commanditaireVo){
                Commanditaire commanditaire = commanditaireService.archiver(commanditaireConverter.toItem(commanditaireVo));
                return commanditaireConverter.toVo(commanditaire);
                }

            @PutMapping("/desarchiver/")
            public CommanditaireVo desarchiver(@RequestBody CommanditaireVo commanditaireVo){
                Commanditaire commanditaire = commanditaireService.desarchiver(commanditaireConverter.toItem(commanditaireVo));
                return commanditaireConverter.toVo(commanditaire);}
            }
