...
private TypeInstrumentIrdConverter typeInstrumentIrdConverter;
    ...
    public List<TypeInstrumentIrdVo> findByCriteria(@RequestBody TypeInstrumentIrdVo typeInstrumentIrdVo){
        return typeInstrumentIrdConverter.toVo(typeInstrumentIrdService.findByCriteria(typeInstrumentIrdVo));
            ...
            @PutMapping("/archiver/")
            public TypeInstrumentIrdVo archiver(@RequestBody TypeInstrumentIrdVo typeInstrumentIrdVo){
                TypeInstrumentIrd typeInstrumentIrd = typeInstrumentIrdService.archiver(typeInstrumentIrdConverter.toItem(typeInstrumentIrdVo));
                return typeInstrumentIrdConverter.toVo(typeInstrumentIrd);
                }

            @PutMapping("/desarchiver/")
            public TypeInstrumentIrdVo desarchiver(@RequestBody TypeInstrumentIrdVo typeInstrumentIrdVo){
                TypeInstrumentIrd typeInstrumentIrd = typeInstrumentIrdService.desarchiver(typeInstrumentIrdConverter.toItem(typeInstrumentIrdVo));
                return typeInstrumentIrdConverter.toVo(typeInstrumentIrd);}
            }
