...
@RestController
@RequestMapping("api/admin/publiqueProfessionel")
public class PubliqueProfessionelRestAdmin {
...
private PubliqueProfessionelConverter publiqueProfessionelConverter;
    ...
    public List<PubliqueProfessionelVo> findByCriteria(@RequestBody PubliqueProfessionelVo publiqueProfessionelVo){
        return publiqueProfessionelConverter.toVo(publiqueProfessionelService.findByCriteria(publiqueProfessionelVo));
            ...
            @PutMapping("/archiver/")
            public PubliqueProfessionelVo archiver(@RequestBody PubliqueProfessionelVo publiqueProfessionelVo){
                PubliqueProfessionel publiqueProfessionel = publiqueProfessionelService.archiver(publiqueProfessionelConverter.toItem(publiqueProfessionelVo));
                return publiqueProfessionelConverter.toVo(publiqueProfessionel);
                }

            @PutMapping("/desarchiver/")
            public PubliqueProfessionelVo desarchiver(@RequestBody PubliqueProfessionelVo publiqueProfessionelVo){
                PubliqueProfessionel publiqueProfessionel = publiqueProfessionelService.desarchiver(publiqueProfessionelConverter.toItem(publiqueProfessionelVo));
                return publiqueProfessionelConverter.toVo(publiqueProfessionel);}
            }
