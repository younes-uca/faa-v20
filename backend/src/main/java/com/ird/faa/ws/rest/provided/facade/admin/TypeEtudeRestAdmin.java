...
@RestController
@RequestMapping("api/admin/typeEtude")
public class TypeEtudeRestAdmin {
...
private TypeEtudeConverter typeEtudeConverter;
    ...
    public List<TypeEtudeVo> findByCriteria(@RequestBody TypeEtudeVo typeEtudeVo){
        return typeEtudeConverter.toVo(typeEtudeService.findByCriteria(typeEtudeVo));
            ...
            @PutMapping("/archiver/")
            public TypeEtudeVo archiver(@RequestBody TypeEtudeVo typeEtudeVo){
                TypeEtude typeEtude = typeEtudeService.archiver(typeEtudeConverter.toItem(typeEtudeVo));
                return typeEtudeConverter.toVo(typeEtude);
                }

            @PutMapping("/desarchiver/")
            public TypeEtudeVo desarchiver(@RequestBody TypeEtudeVo typeEtudeVo){
                TypeEtude typeEtude = typeEtudeService.desarchiver(typeEtudeConverter.toItem(typeEtudeVo));
                return typeEtudeConverter.toVo(typeEtude);}
            }
