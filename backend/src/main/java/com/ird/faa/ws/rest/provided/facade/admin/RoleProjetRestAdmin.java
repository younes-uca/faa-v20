...
private RoleProjetConverter roleProjetConverter;
    ...
    public List<RoleProjetVo> findByCriteria(@RequestBody RoleProjetVo roleProjetVo){
        return roleProjetConverter.toVo(roleProjetService.findByCriteria(roleProjetVo));
            ...
            @PutMapping("/archiver/")
            public RoleProjetVo archiver(@RequestBody RoleProjetVo roleProjetVo){
                RoleProjet roleProjet = roleProjetService.archiver(roleProjetConverter.toItem(roleProjetVo));
                return roleProjetConverter.toVo(roleProjet);
                }

            @PutMapping("/desarchiver/")
            public RoleProjetVo desarchiver(@RequestBody RoleProjetVo roleProjetVo){
                RoleProjet roleProjet = roleProjetService.desarchiver(roleProjetConverter.toItem(roleProjetVo));
                return roleProjetConverter.toVo(roleProjet);}
            }
