...
private ModeDiffusionConverter modeDiffusionConverter;
    ...
    public List<ModeDiffusionVo> findByCriteria(@RequestBody ModeDiffusionVo modeDiffusionVo){
        ...
        return modeDiffusionService.deleteByTypeSavoirId(id);
            ...
            @PutMapping("/archiver/")
            public ModeDiffusionVo archiver(@RequestBody ModeDiffusionVo modeDiffusionVo){
                ModeDiffusion modeDiffusion = modeDiffusionService.archiver(modeDiffusionConverter.toItem(modeDiffusionVo));
                return modeDiffusionConverter.toVo(modeDiffusion);
                }

            @PutMapping("/desarchiver/")
            public ModeDiffusionVo desarchiver(@RequestBody ModeDiffusionVo modeDiffusionVo){
                ModeDiffusion modeDiffusion = modeDiffusionService.desarchiver(modeDiffusionConverter.toItem(modeDiffusionVo));
                return modeDiffusionConverter.toVo(modeDiffusion);}
            }
