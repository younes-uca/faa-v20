...
private NatureEnseignementConverter natureEnseignementConverter;
    ...
    public List<NatureEnseignementVo> findByCriteria(@RequestBody NatureEnseignementVo natureEnseignementVo){
        return natureEnseignementConverter.toVo(natureEnseignementService.findByCriteria(natureEnseignementVo));
            ...
            @PutMapping("/archiver/")
            public NatureEnseignementVo archiver(@RequestBody NatureEnseignementVo natureEnseignementVo){
                NatureEnseignement natureEnseignement = natureEnseignementService.archiver(natureEnseignementConverter.toItem(natureEnseignementVo));
                return natureEnseignementConverter.toVo(natureEnseignement);
                }

            @PutMapping("/desarchiver/")
            public NatureEnseignementVo desarchiver(@RequestBody NatureEnseignementVo natureEnseignementVo){
                NatureEnseignement natureEnseignement = natureEnseignementService.desarchiver(natureEnseignementConverter.toItem(natureEnseignementVo));
                return natureEnseignementConverter.toVo(natureEnseignement);}
            }
