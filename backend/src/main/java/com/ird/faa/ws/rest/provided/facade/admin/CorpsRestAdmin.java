...
private CorpsConverter corpsConverter;
    ...
    public List<CorpsVo> findByCriteria(@RequestBody CorpsVo corpsVo){
        return corpsConverter.toVo(corpsService.findByCriteria(corpsVo));
            ...
            @PutMapping("/archiver/")
            public CorpsVo archiver(@RequestBody CorpsVo corpsVo){
                Corps corps = corpsService.archiver(corpsConverter.toItem(corpsVo));
                return corpsConverter.toVo(corps);
                }

            @PutMapping("/desarchiver/")
            public CorpsVo desarchiver(@RequestBody CorpsVo corpsVo){
                Corps corps = corpsService.desarchiver(corpsConverter.toItem(corpsVo));
                return corpsConverter.toVo(corps);}
            }
