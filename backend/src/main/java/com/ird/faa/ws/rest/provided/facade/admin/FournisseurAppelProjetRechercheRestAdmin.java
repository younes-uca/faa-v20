...
private FournisseurAppelProjetRechercheConverter fournisseurAppelProjetRechercheConverter;
    ...
    public List<FournisseurAppelProjetRechercheVo> findByCriteria(@RequestBody FournisseurAppelProjetRechercheVo fournisseurAppelProjetRechercheVo){
        ...
        return fournisseurAppelProjetRechercheService.deleteByPaysId(id);
            ...
            @PutMapping("/archiver/")
            public FournisseurAppelProjetRechercheVo archiver(@RequestBody FournisseurAppelProjetRechercheVo fournisseurAppelProjetRechercheVo){
                FournisseurAppelProjetRecherche fournisseurAppelProjetRecherche = fournisseurAppelProjetRechercheService.archiver(fournisseurAppelProjetRechercheConverter.toItem(fournisseurAppelProjetRechercheVo));
                return fournisseurAppelProjetRechercheConverter.toVo(fournisseurAppelProjetRecherche);
                }

            @PutMapping("/desarchiver/")
            public FournisseurAppelProjetRechercheVo desarchiver(@RequestBody FournisseurAppelProjetRechercheVo fournisseurAppelProjetRechercheVo){
                FournisseurAppelProjetRecherche fournisseurAppelProjetRecherche = fournisseurAppelProjetRechercheService.desarchiver(fournisseurAppelProjetRechercheConverter.toItem(fournisseurAppelProjetRechercheVo));
                return fournisseurAppelProjetRechercheConverter.toVo(fournisseurAppelProjetRecherche);}
            }
