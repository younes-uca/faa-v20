...
private DepartementScientifiqueConverter departementScientifiqueConverter;
    ...
    public List<DepartementScientifiqueVo> findByCriteria(@RequestBody DepartementScientifiqueVo departementScientifiqueVo){
        return departementScientifiqueConverter.toVo(departementScientifiqueService.findByCriteria(departementScientifiqueVo));
            ...
            @PutMapping("/archiver/")
            public DepartementScientifiqueVo archiver(@RequestBody DepartementScientifiqueVo departementScientifiqueVo){
                DepartementScientifique departementScientifique = departementScientifiqueService.archiver(departementScientifiqueConverter.toItem(departementScientifiqueVo));
                return departementScientifiqueConverter.toVo(departementScientifique);
                }

            @PutMapping("/desarchiver/")
            public DepartementScientifiqueVo desarchiver(@RequestBody DepartementScientifiqueVo departementScientifiqueVo){
                DepartementScientifique departementScientifique = departementScientifiqueService.desarchiver(departementScientifiqueConverter.toItem(departementScientifiqueVo));
                return departementScientifiqueConverter.toVo(departementScientifique);}
            }
