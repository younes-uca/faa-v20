...
private GradeConverter gradeConverter;
    ...
    public List<GradeVo> findByCriteria(@RequestBody GradeVo gradeVo){
        return gradeConverter.toVo(gradeService.findByCriteria(gradeVo));
            ...
            @PutMapping("/archiver/")
            public GradeVo archiver(@RequestBody GradeVo gradeVo){
                Grade grade = gradeService.archiver(gradeConverter.toItem(gradeVo));
                return gradeConverter.toVo(grade);
                }

            @PutMapping("/desarchiver/")
            public GradeVo desarchiver(@RequestBody GradeVo gradeVo){
                Grade grade = gradeService.desarchiver(gradeConverter.toItem(gradeVo));
                return gradeConverter.toVo(grade);}
            }
