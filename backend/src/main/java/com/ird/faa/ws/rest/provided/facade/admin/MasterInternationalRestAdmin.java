...
private MasterInternationalConverter masterInternationalConverter;
    ...
    public List<MasterInternationalVo> findByCriteria(@RequestBody MasterInternationalVo masterInternationalVo){
        return masterInternationalConverter.toVo(masterInternationalService.findByCriteria(masterInternationalVo));
            ...
            @PutMapping("/archiver/")
            public MasterInternationalVo archiver(@RequestBody MasterInternationalVo masterInternationalVo){
                MasterInternational masterInternational = masterInternationalService.archiver(masterInternationalConverter.toItem(masterInternationalVo));
                return masterInternationalConverter.toVo(masterInternational);
                }

            @PutMapping("/desarchiver/")
            public MasterInternationalVo desarchiver(@RequestBody MasterInternationalVo masterInternationalVo){
                MasterInternational masterInternational = masterInternationalService.desarchiver(masterInternationalConverter.toItem(masterInternationalVo));
                return masterInternationalConverter.toVo(masterInternational);}
            }
