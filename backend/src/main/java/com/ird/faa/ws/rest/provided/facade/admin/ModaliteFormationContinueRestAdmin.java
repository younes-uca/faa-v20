...
private ModaliteFormationContinueConverter modaliteFormationContinueConverter;
    ...
    public List<ModaliteFormationContinueVo> findByCriteria(@RequestBody ModaliteFormationContinueVo modaliteFormationContinueVo){
        return modaliteFormationContinueConverter.toVo(modaliteFormationContinueService.findByCriteria(modaliteFormationContinueVo));
            ...
            @PutMapping("/archiver/")
            public ModaliteFormationContinueVo archiver(@RequestBody ModaliteFormationContinueVo modaliteFormationContinueVo){
                ModaliteFormationContinue modaliteFormationContinue = modaliteFormationContinueService.archiver(modaliteFormationContinueConverter.toItem(modaliteFormationContinueVo));
                return modaliteFormationContinueConverter.toVo(modaliteFormationContinue);
                }

            @PutMapping("/desarchiver/")
            public ModaliteFormationContinueVo desarchiver(@RequestBody ModaliteFormationContinueVo modaliteFormationContinueVo){
                ModaliteFormationContinue modaliteFormationContinue = modaliteFormationContinueService.desarchiver(modaliteFormationContinueConverter.toItem(modaliteFormationContinueVo));
                return modaliteFormationContinueConverter.toVo(modaliteFormationContinue);}
            }
