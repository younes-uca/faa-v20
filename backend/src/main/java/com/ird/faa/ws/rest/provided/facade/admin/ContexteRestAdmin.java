...
private ContexteConverter contexteConverter;
    ...
    public List<ContexteVo> findByCriteria(@RequestBody ContexteVo contexteVo){
        return contexteConverter.toVo(contexteService.findByCriteria(contexteVo));
            ...
            @PutMapping("/archiver/")
            public ContexteVo archiver(@RequestBody ContexteVo contexteVo){
                Contexte contexte = contexteService.archiver(contexteConverter.toItem(contexteVo));
                return contexteConverter.toVo(contexte);
                }

            @PutMapping("/desarchiver/")
            public ContexteVo desarchiver(@RequestBody ContexteVo contexteVo){
                Contexte contexte = contexteService.desarchiver(contexteConverter.toItem(contexteVo));
                return contexteConverter.toVo(contexte);}
            }
