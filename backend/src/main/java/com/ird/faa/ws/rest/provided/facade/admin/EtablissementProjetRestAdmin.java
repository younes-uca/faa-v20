...
private EtablissementProjetConverter etablissementProjetConverter;
    ...
    public List<EtablissementProjetVo> findByCriteria(@RequestBody EtablissementProjetVo etablissementProjetVo){
        ...
        return etablissementProjetService.deleteByPaysId(id);
            ...
            @PutMapping("/archiver/")
            public EtablissementProjetVo archiver(@RequestBody EtablissementProjetVo etablissementProjetVo){
                EtablissementProjet etablissementProjet = etablissementProjetService.archiver(etablissementProjetConverter.toItem(etablissementProjetVo));
                return etablissementProjetConverter.toVo(etablissementProjet);
                }

            @PutMapping("/desarchiver/")
            public EtablissementProjetVo desarchiver(@RequestBody EtablissementProjetVo etablissementProjetVo){
                EtablissementProjet etablissementProjet = etablissementProjetService.desarchiver(etablissementProjetConverter.toItem(etablissementProjetVo));
                return etablissementProjetConverter.toVo(etablissementProjet);}
            }
