...
private TemplateRelanceConverter templateRelanceConverter;
    ...
    public List<TemplateRelanceVo> findByCriteria(@RequestBody TemplateRelanceVo templateRelanceVo){
        return templateRelanceConverter.toVo(templateRelanceService.findByCriteria(templateRelanceVo));
            ...
            @PutMapping("/archiver/")
            public TemplateRelanceVo archiver(@RequestBody TemplateRelanceVo templateRelanceVo){
                TemplateRelance templateRelance = templateRelanceService.archiver(templateRelanceConverter.toItem(templateRelanceVo));
                return templateRelanceConverter.toVo(templateRelance);
                }

            @PutMapping("/desarchiver/")
            public TemplateRelanceVo desarchiver(@RequestBody TemplateRelanceVo templateRelanceVo){
                TemplateRelance templateRelance = templateRelanceService.desarchiver(templateRelanceConverter.toItem(templateRelanceVo));
                return templateRelanceConverter.toVo(templateRelance);}
            }
