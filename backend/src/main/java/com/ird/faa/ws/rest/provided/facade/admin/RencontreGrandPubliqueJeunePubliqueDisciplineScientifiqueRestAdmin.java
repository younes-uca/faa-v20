...
@RestController
@RequestMapping("api/admin/rencontreGrandPubliqueJeunePubliqueDisciplineScientifique")
public class RencontreGrandPubliqueJeunePubliqueDisciplineScientifiqueRestAdmin {
