...
private SexeConverter sexeConverter;
    ...
    public List<SexeVo> findByCriteria(@RequestBody SexeVo sexeVo){
        return sexeConverter.toVo(sexeService.findByCriteria(sexeVo));
            ...
            @PutMapping("/archiver/")
            public SexeVo archiver(@RequestBody SexeVo sexeVo){
                Sexe sexe = sexeService.archiver(sexeConverter.toItem(sexeVo));
                return sexeConverter.toVo(sexe);
                }

            @PutMapping("/desarchiver/")
            public SexeVo desarchiver(@RequestBody SexeVo sexeVo){
                Sexe sexe = sexeService.desarchiver(sexeConverter.toItem(sexeVo));
                return sexeConverter.toVo(sexe);}
            }
