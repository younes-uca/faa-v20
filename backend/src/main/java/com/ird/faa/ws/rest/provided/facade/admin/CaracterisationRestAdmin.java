...
private CaracterisationConverter caracterisationConverter;
    ...
    public List<CaracterisationVo> findByCriteria(@RequestBody CaracterisationVo caracterisationVo){
        return caracterisationConverter.toVo(caracterisationService.findByCriteria(caracterisationVo));
            ...
            @PutMapping("/archiver/")
            public CaracterisationVo archiver(@RequestBody CaracterisationVo caracterisationVo){
                Caracterisation caracterisation = caracterisationService.archiver(caracterisationConverter.toItem(caracterisationVo));
                return caracterisationConverter.toVo(caracterisation);
                }

            @PutMapping("/desarchiver/")
            public CaracterisationVo desarchiver(@RequestBody CaracterisationVo caracterisationVo){
                Caracterisation caracterisation = caracterisationService.desarchiver(caracterisationConverter.toItem(caracterisationVo));
                return caracterisationConverter.toVo(caracterisation);}
            }
