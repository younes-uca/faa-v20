...
private CommissionScientifiqueConverter commissionScientifiqueConverter;
    ...
    public List<CommissionScientifiqueVo> findByCriteria(@RequestBody CommissionScientifiqueVo commissionScientifiqueVo){
        return commissionScientifiqueConverter.toVo(commissionScientifiqueService.findByCriteria(commissionScientifiqueVo));
            ...
            @PutMapping("/archiver/")
            public CommissionScientifiqueVo archiver(@RequestBody CommissionScientifiqueVo commissionScientifiqueVo){
                CommissionScientifique commissionScientifique = commissionScientifiqueService.archiver(commissionScientifiqueConverter.toItem(commissionScientifiqueVo));
                return commissionScientifiqueConverter.toVo(commissionScientifique);
                }

            @PutMapping("/desarchiver/")
            public CommissionScientifiqueVo desarchiver(@RequestBody CommissionScientifiqueVo commissionScientifiqueVo){
                CommissionScientifique commissionScientifique = commissionScientifiqueService.desarchiver(commissionScientifiqueConverter.toItem(commissionScientifiqueVo));
                return commissionScientifiqueConverter.toVo(commissionScientifique);}
            }
