...
@RestController
@RequestMapping("api/admin/publiqueCible")
public class PubliqueCibleRestAdmin {
...
private PubliqueCibleConverter publiqueCibleConverter;
    ...
    public List<PubliqueCibleVo> findByCriteria(@RequestBody PubliqueCibleVo publiqueCibleVo){
        return publiqueCibleConverter.toVo(publiqueCibleService.findByCriteria(publiqueCibleVo));
            ...
            @PutMapping("/archiver/")
            public PubliqueCibleVo archiver(@RequestBody PubliqueCibleVo publiqueCibleVo){
                PubliqueCible publiqueCible = publiqueCibleService.archiver(publiqueCibleConverter.toItem(publiqueCibleVo));
                return publiqueCibleConverter.toVo(publiqueCible);
                }

            @PutMapping("/desarchiver/")
            public PubliqueCibleVo desarchiver(@RequestBody PubliqueCibleVo publiqueCibleVo){
                PubliqueCible publiqueCible = publiqueCibleService.desarchiver(publiqueCibleConverter.toItem(publiqueCibleVo));
                return publiqueCibleConverter.toVo(publiqueCible);}
            }
