...
public interface PubliqueCibleAdminService extends AbstractService<PubliqueCible,Long,PubliqueCibleVo>{
...
/**
    ...
    */
    ...
    PubliqueCible archiver(PubliqueCible publiqueCible) ;
    PubliqueCible desarchiver(PubliqueCible publiqueCible);
