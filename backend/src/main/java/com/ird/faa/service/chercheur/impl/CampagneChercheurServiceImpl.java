...
public class CampagneChercheurServiceImpl extends AbstractServiceImpl<Campagne> implements CampagneChercheurService {
    ...
    public List<Campagne> findAll() {
        ...
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())) {
            return campagneDao.findByChercheurUsername(currentUser.getUsername());
        }
    ...
    public Campagne save(Campagne campagne) {
        ...
        if (foundedCampagne == null) {
            ...
            if (laodedCampagne == null) {
                ...
                campagne.setChercheur(loadedChercheur);
                campagne.setCampagne(laodedCampagne);
    ...
    public List<Campagne> findByChercheurUsernameAndCampagneId(String username, Long compagneId) {
        List<Campagne> resultat = campagneDao.findByChercheurUsernameAndCampagneId(username, compagneId);
        return resultat;
    }
