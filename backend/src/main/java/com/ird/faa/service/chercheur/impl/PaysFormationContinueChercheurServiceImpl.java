...
@Service
public class PaysFormationContinueChercheurServiceImpl extends AbstractServiceImpl<PaysFormationContinue> implements PaysFormationContinueChercheurService {
