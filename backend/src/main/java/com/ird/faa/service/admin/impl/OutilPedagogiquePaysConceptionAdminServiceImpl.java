...
@Service
public class OutilPedagogiquePaysConceptionAdminServiceImpl extends AbstractServiceImpl<OutilPedagogiquePaysConception> implements OutilPedagogiquePaysConceptionAdminService {
