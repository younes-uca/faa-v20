...
import com.ird.faa.dao.DisciplineScientifiqueEncadrementEtudiantDao;
...
int res=0;
if(disciplineScientifiqueEncadrementEtudiantDao.findById(id).isPresent())  {
...
List<DisciplineScientifiqueEncadrementEtudiant> list = new ArrayList<>();
