...
return findById(id);
     ...
     @Override
    public Nationalite archiver(Nationalite nationalite) {
        if (nationalite.getArchive() == null) {
        nationalite.setArchive(false);
        }
        nationalite.setArchive(true);
        nationalite.setDateArchivage(new Date());
    ...
    @Override
    public Nationalite desarchiver(Nationalite nationalite) {
    if (nationalite.getArchive() == null) {
    nationalite.setArchive(false);
    }
    nationalite.setArchive(false);
    nationalite.setDateArchivage(null);
    nationaliteDao.save(nationalite);
    return nationalite;
    }
