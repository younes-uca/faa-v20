...
return findById(id);
     ...
     @Override
    public ModaliteFormationContinue archiver(ModaliteFormationContinue modaliteFormationContinue) {
        if (modaliteFormationContinue.getArchive() == null) {
        modaliteFormationContinue.setArchive(false);
        }
        modaliteFormationContinue.setArchive(true);
        modaliteFormationContinue.setDateArchivage(new Date());
        modaliteFormationContinueDao.save(modaliteFormationContinue);
        return modaliteFormationContinue;

    }

    @Override
    public ModaliteFormationContinue desarchiver(ModaliteFormationContinue modaliteFormationContinue) {
    if (modaliteFormationContinue.getArchive() == null) {
    modaliteFormationContinue.setArchive(false);
    }
    modaliteFormationContinue.setArchive(false);
    modaliteFormationContinue.setDateArchivage(null);
    modaliteFormationContinueDao.save(modaliteFormationContinue);
    return modaliteFormationContinue;
    }
