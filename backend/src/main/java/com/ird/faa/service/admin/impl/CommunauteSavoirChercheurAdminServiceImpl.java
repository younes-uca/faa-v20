...
import com.ird.faa.dao.CommunauteSavoirChercheurDao;
...
int res=0;
if(communauteSavoirChercheurDao.findById(id).isPresent())  {
...
List<CommunauteSavoirChercheur> list = new ArrayList<>();
