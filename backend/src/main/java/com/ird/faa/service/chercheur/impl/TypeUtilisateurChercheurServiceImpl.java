...
@Service
public class TypeUtilisateurChercheurServiceImpl extends AbstractServiceImpl<TypeUtilisateur> implements TypeUtilisateurChercheurService {
...
public List<TypeUtilisateur> findAll(){
    String query = "SELECT o FROM TypeUtilisateur o ";
