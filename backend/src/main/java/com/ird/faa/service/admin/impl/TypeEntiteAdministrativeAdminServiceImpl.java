...
return findById(id);
     ...
     @Override
    public TypeEntiteAdministrative archiver(TypeEntiteAdministrative typeEntiteAdministrative) {
        if (typeEntiteAdministrative.getArchive() == null) {
        typeEntiteAdministrative.setArchive(false);
        }
        typeEntiteAdministrative.setArchive(true);
        typeEntiteAdministrative.setDateArchivage(new Date());
        typeEntiteAdministrativeDao.save(typeEntiteAdministrative);
        return typeEntiteAdministrative;

    }

    @Override
    public TypeEntiteAdministrative desarchiver(TypeEntiteAdministrative typeEntiteAdministrative) {
    if (typeEntiteAdministrative.getArchive() == null) {
    typeEntiteAdministrative.setArchive(false);
    }
    typeEntiteAdministrative.setArchive(false);
    typeEntiteAdministrative.setDateArchivage(null);
    typeEntiteAdministrativeDao.save(typeEntiteAdministrative);
    return typeEntiteAdministrative;
    }
