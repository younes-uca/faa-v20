...
return findById(id);
     ...
     @Override
    public NiveauEtude archiver(NiveauEtude niveauEtude) {
        if (niveauEtude.getArchive() == null) {
        niveauEtude.setArchive(false);
        }
        niveauEtude.setArchive(true);
        niveauEtude.setDateArchivage(new Date());
    ...
    @Override
    public NiveauEtude desarchiver(NiveauEtude niveauEtude) {
    if (niveauEtude.getArchive() == null) {
    niveauEtude.setArchive(false);
    }
    niveauEtude.setArchive(false);
    niveauEtude.setDateArchivage(null);
    niveauEtudeDao.save(niveauEtude);
    return niveauEtude;
    }
