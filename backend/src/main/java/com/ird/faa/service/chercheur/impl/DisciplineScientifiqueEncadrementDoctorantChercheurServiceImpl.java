...
import com.ird.faa.dao.DisciplineScientifiqueEncadrementDoctorantDao;
...
int res=0;
if(disciplineScientifiqueEncadrementDoctorantDao.findById(id).isPresent())  {
...
List<DisciplineScientifiqueEncadrementDoctorant> list = new ArrayList<>();
