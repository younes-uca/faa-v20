...
@Service
public class CultureScientifiqueChercheurServiceImpl extends AbstractServiceImpl<CultureScientifique> implements CultureScientifiqueChercheurService {
...
List<CultureScientifique> resultat= cultureScientifiqueDao.findByChercheurUsernameAndCampagneId(username, compagneId);
    return resultat;
}
