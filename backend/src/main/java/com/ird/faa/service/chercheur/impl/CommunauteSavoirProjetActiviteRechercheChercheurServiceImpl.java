...
import com.ird.faa.dao.CommunauteSavoirProjetActiviteRechercheDao;
...
int res=0;
if(communauteSavoirProjetActiviteRechercheDao.findById(id).isPresent())  {
...
List<CommunauteSavoirProjetActiviteRecherche> list = new ArrayList<>();
