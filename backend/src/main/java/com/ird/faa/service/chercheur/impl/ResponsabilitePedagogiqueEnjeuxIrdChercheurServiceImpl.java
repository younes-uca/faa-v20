...
import com.ird.faa.dao.ResponsabilitePedagogiqueEnjeuxIrdDao;
...
@Service
public class ResponsabilitePedagogiqueEnjeuxIrdChercheurServiceImpl extends AbstractServiceImpl<ResponsabilitePedagogiqueEnjeuxIrd> implements ResponsabilitePedagogiqueEnjeuxIrdChercheurService {
...
@Override
public ResponsabilitePedagogiqueEnjeuxIrd update(ResponsabilitePedagogiqueEnjeuxIrd responsabilitePedagogiqueEnjeuxIrd){
ResponsabilitePedagogiqueEnjeuxIrd foundedResponsabilitePedagogiqueEnjeuxIrd = findById(responsabilitePedagogiqueEnjeuxIrd.getId());
if(foundedResponsabilitePedagogiqueEnjeuxIrd==null) return null;
else{
...
@Override
public ResponsabilitePedagogiqueEnjeuxIrd save (ResponsabilitePedagogiqueEnjeuxIrd responsabilitePedagogiqueEnjeuxIrd){
...
@Override
public List<ResponsabilitePedagogiqueEnjeuxIrd> save(List<ResponsabilitePedagogiqueEnjeuxIrd> responsabilitePedagogiqueEnjeuxIrds){
...
public int delete(ResponsabilitePedagogiqueEnjeuxIrd responsabilitePedagogiqueEnjeuxIrd){
    if(responsabilitePedagogiqueEnjeuxIrd.getId()==null) return -1;
    ResponsabilitePedagogiqueEnjeuxIrd foundedResponsabilitePedagogiqueEnjeuxIrd = findById(responsabilitePedagogiqueEnjeuxIrd.getId());
    if(foundedResponsabilitePedagogiqueEnjeuxIrd==null) return -1;
responsabilitePedagogiqueEnjeuxIrdDao.delete(foundedResponsabilitePedagogiqueEnjeuxIrd);
return 1;
}


public List<ResponsabilitePedagogiqueEnjeuxIrd> findByCriteria(ResponsabilitePedagogiqueEnjeuxIrdVo responsabilitePedagogiqueEnjeuxIrdVo){
...
String query = "SELECT o FROM ResponsabilitePedagogiqueEnjeuxIrd o where 1=1 ";
    ...
    if(responsabilitePedagogiqueEnjeuxIrdVo.getEnjeuxIrdVo()!=null){
        query += SearchUtil.addConstraint( "o", "enjeuxIrd.id","=",responsabilitePedagogiqueEnjeuxIrdVo.getEnjeuxIrdVo().getId());
            query += SearchUtil.addConstraint( "o", "enjeuxIrd.code","LIKE",responsabilitePedagogiqueEnjeuxIrdVo.getEnjeuxIrdVo().getCode());
    }

    if(responsabilitePedagogiqueEnjeuxIrdVo.getResponsabilitePedagogiqueVo()!=null){
        query += SearchUtil.addConstraint( "o", "responsabilitePedagogique.id","=",responsabilitePedagogiqueEnjeuxIrdVo.getResponsabilitePedagogiqueVo().getId());
    }
...
return entityManager.createQuery(query).getResultList();
    ...
    private void findResponsabilitePedagogique(ResponsabilitePedagogiqueEnjeuxIrd responsabilitePedagogiqueEnjeuxIrd){
        ...
        if(responsabilitePedagogiqueEnjeuxIrd.getResponsabilitePedagogique() != null && responsabilitePedagogiqueEnjeuxIrd.getResponsabilitePedagogique().getId() !=null)
        loadedResponsabilitePedagogique =responsabilitePedagogiqueService.findById(responsabilitePedagogiqueEnjeuxIrd.getResponsabilitePedagogique().getId());
