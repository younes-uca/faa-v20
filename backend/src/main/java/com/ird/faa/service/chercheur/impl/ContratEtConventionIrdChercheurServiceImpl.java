...
@Service
public class ContratEtConventionIrdChercheurServiceImpl extends AbstractServiceImpl<ContratEtConventionIrd> implements ContratEtConventionIrdChercheurService {
