...
import com.ird.faa.bean.ResponsabilitePedagogique;
...
import com.ird.faa.dao.ResponsabilitePedagogiqueDao;
...
@Service
public class ResponsabilitePedagogiqueChercheurServiceImpl extends AbstractServiceImpl<ResponsabilitePedagogique> implements ResponsabilitePedagogiqueChercheurService {
...
if(responsabilitePedagogique!=null && responsabilitePedagogique.getId() != null) {
        List<ResponsabilitePedagogiqueEnjeuxIrd> responsabilitePedagogiqueEnjeuxIrds = responsabilitePedagogiqueEnjeuxIrdService.findByResponsabilitePedagogiqueId(responsabilitePedagogique.getId());
        responsabilitePedagogique.setResponsabilitePedagogiqueEnjeuxIrds(responsabilitePedagogiqueEnjeuxIrds);
        List<ResponsabilitePedagogiqueEtablissement> responsabilitePedagogiqueEtablissements = responsabilitePedagogiqueEtablissementService.findByResponsabilitePedagogiqueId(responsabilitePedagogique.getId());
        responsabilitePedagogique.setResponsabilitePedagogiqueEtablissements(responsabilitePedagogiqueEtablissements);
        List<ResponsabilitePedagogiquePays> responsabilitePedagogiquePayss = responsabilitePedagogiquePaysService.findByResponsabilitePedagogiqueId(responsabilitePedagogique.getId());
...
if(id != null ) {
    ...
    if(responsabilitePedagogique !=null && responsabilitePedagogique.getId() != null){
            List<List<ResponsabilitePedagogiqueEnjeuxIrd>> resultResponsabilitePedagogiqueEnjeuxIrds= responsabilitePedagogiqueEnjeuxIrdService.getToBeSavedAndToBeDeleted(responsabilitePedagogiqueEnjeuxIrdService.findByResponsabilitePedagogiqueId(responsabilitePedagogique.getId()),responsabilitePedagogique.getResponsabilitePedagogiqueEnjeuxIrds());
            responsabilitePedagogiqueEnjeuxIrdService.delete(resultResponsabilitePedagogiqueEnjeuxIrds.get(1));
            associateResponsabilitePedagogiqueEnjeuxIrd(responsabilitePedagogique,resultResponsabilitePedagogiqueEnjeuxIrds.get(0));
            responsabilitePedagogiqueEnjeuxIrdService.update(resultResponsabilitePedagogiqueEnjeuxIrds.get(0));

            List<List<ResponsabilitePedagogiqueEtablissement>> resultResponsabilitePedagogiqueEtablissements= responsabilitePedagogiqueEtablissementService.getToBeSavedAndToBeDeleted(responsabilitePedagogiqueEtablissementService.findByResponsabilitePedagogiqueId(responsabilitePedagogique.getId()),responsabilitePedagogique.getResponsabilitePedagogiqueEtablissements());
            responsabilitePedagogiqueEtablissementService.delete(resultResponsabilitePedagogiqueEtablissements.get(1));
            associateResponsabilitePedagogiqueEtablissement(responsabilitePedagogique,resultResponsabilitePedagogiqueEtablissements.get(0));
            responsabilitePedagogiqueEtablissementService.update(resultResponsabilitePedagogiqueEtablissements.get(0));

            List<List<ResponsabilitePedagogiquePays>> resultResponsabilitePedagogiquePayss= responsabilitePedagogiquePaysService.getToBeSavedAndToBeDeleted(responsabilitePedagogiquePaysService.findByResponsabilitePedagogiqueId(responsabilitePedagogique.getId()),responsabilitePedagogique.getResponsabilitePedagogiquePayss());
            responsabilitePedagogiquePaysService.delete(resultResponsabilitePedagogiquePayss.get(1));
            associateResponsabilitePedagogiquePays(responsabilitePedagogique,resultResponsabilitePedagogiquePayss.get(0));
...
if(foundedResponsabilitePedagogique==null) return null;
else{
...
ResponsabilitePedagogique savedResponsabilitePedagogique = responsabilitePedagogiqueDao.save(responsabilitePedagogique);

       saveResponsabilitePedagogiqueEnjeuxIrds(savedResponsabilitePedagogique,responsabilitePedagogique.getResponsabilitePedagogiqueEnjeuxIrds());
       saveResponsabilitePedagogiqueEtablissements(savedResponsabilitePedagogique,responsabilitePedagogique.getResponsabilitePedagogiqueEtablissements());
       saveResponsabilitePedagogiquePayss(savedResponsabilitePedagogique,responsabilitePedagogique.getResponsabilitePedagogiquePayss());
...
return list;
        ...
        private List<ResponsabilitePedagogiqueEnjeuxIrd> prepareResponsabilitePedagogiqueEnjeuxIrds(ResponsabilitePedagogique responsabilitePedagogique,List<ResponsabilitePedagogiqueEnjeuxIrd> responsabilitePedagogiqueEnjeuxIrds){
        ...
        private List<ResponsabilitePedagogiqueEtablissement> prepareResponsabilitePedagogiqueEtablissements(ResponsabilitePedagogique responsabilitePedagogique,List<ResponsabilitePedagogiqueEtablissement> responsabilitePedagogiqueEtablissements){
        ...
        private List<ResponsabilitePedagogiquePays> prepareResponsabilitePedagogiquePayss(ResponsabilitePedagogique responsabilitePedagogique,List<ResponsabilitePedagogiquePays> responsabilitePedagogiquePayss){
...
public int delete(ResponsabilitePedagogique responsabilitePedagogique){
    if(responsabilitePedagogique.getId()==null) return -1;
    ResponsabilitePedagogique foundedResponsabilitePedagogique = findById(responsabilitePedagogique.getId());
    if(foundedResponsabilitePedagogique==null) return -1;
...
String query = "SELECT o FROM ResponsabilitePedagogique o where 1=1 ";
            ...
            query += SearchUtil.addConstraint( "o", "intituleCursus","LIKE",responsabilitePedagogiqueVo.getIntituleCursus());
            query += SearchUtil.addConstraint( "o", "serviceRenforcementCapacite","=",responsabilitePedagogiqueVo.getServiceRenforcementCapacite());
            query += SearchUtil.addConstraint( "o", "cursusConstruitAvecEtablissements","=",responsabilitePedagogiqueVo.getCursusConstruitAvecEtablissements());
    if(responsabilitePedagogiqueVo.getNiveauResponsabilitePedagogiqueVo()!=null){
        query += SearchUtil.addConstraint( "o", "niveauResponsabilitePedagogique.id","=",responsabilitePedagogiqueVo.getNiveauResponsabilitePedagogiqueVo().getId());
            query += SearchUtil.addConstraint( "o", "niveauResponsabilitePedagogique.code","LIKE",responsabilitePedagogiqueVo.getNiveauResponsabilitePedagogiqueVo().getCode());
    }

    if(responsabilitePedagogiqueVo.getStatusCursusVo()!=null){
        query += SearchUtil.addConstraint( "o", "statusCursus.id","=",responsabilitePedagogiqueVo.getStatusCursusVo().getId());
            query += SearchUtil.addConstraint( "o", "statusCursus.code","LIKE",responsabilitePedagogiqueVo.getStatusCursusVo().getCode());
    }

    if(responsabilitePedagogiqueVo.getEtatEtapeCampagneVo()!=null){
        query += SearchUtil.addConstraint( "o", "etatEtapeCampagne.id","=",responsabilitePedagogiqueVo.getEtatEtapeCampagneVo().getId());
            query += SearchUtil.addConstraint( "o", "etatEtapeCampagne.code","LIKE",responsabilitePedagogiqueVo.getEtatEtapeCampagneVo().getCode());
    }

    if(responsabilitePedagogiqueVo.getEnseignementEtFormationVo()!=null){
        query += SearchUtil.addConstraint( "o", "enseignementEtFormation.id","=",responsabilitePedagogiqueVo.getEnseignementEtFormationVo().getId());
    }

return entityManager.createQuery(query).getResultList();
}
        private  void saveResponsabilitePedagogiqueEnjeuxIrds(ResponsabilitePedagogique responsabilitePedagogique,List<ResponsabilitePedagogiqueEnjeuxIrd> responsabilitePedagogiqueEnjeuxIrds){
        ...
        private  void saveResponsabilitePedagogiqueEtablissements(ResponsabilitePedagogique responsabilitePedagogique,List<ResponsabilitePedagogiqueEtablissement> responsabilitePedagogiqueEtablissements){
        ...
        responsabilitePedagogique.setResponsabilitePedagogiqueEtablissements(savedResponsabilitePedagogiqueEtablissements);
        }
        }
        private  void saveResponsabilitePedagogiquePayss(ResponsabilitePedagogique responsabilitePedagogique,List<ResponsabilitePedagogiquePays> responsabilitePedagogiquePayss){
    ...
    private void findNiveauResponsabilitePedagogique(ResponsabilitePedagogique responsabilitePedagogique){
        NiveauResponsabilitePedagogique loadedNiveauResponsabilitePedagogique =niveauResponsabilitePedagogiqueService.findByIdOrCode(responsabilitePedagogique.getNiveauResponsabilitePedagogique());
    ...
    private void findStatusCursus(ResponsabilitePedagogique responsabilitePedagogique){
        StatusCursus loadedStatusCursus =statusCursusService.findByIdOrCode(responsabilitePedagogique.getStatusCursus());
    ...
    private void findEtatEtapeCampagne(ResponsabilitePedagogique responsabilitePedagogique){
        EtatEtapeCampagne loadedEtatEtapeCampagne =etatEtapeCampagneService.findByIdOrCode(responsabilitePedagogique.getEtatEtapeCampagne());
    ...
    private void findEnseignementEtFormation(ResponsabilitePedagogique responsabilitePedagogique){
        ...
        if(responsabilitePedagogique.getEnseignementEtFormation() != null && responsabilitePedagogique.getEnseignementEtFormation().getId() !=null)
        loadedEnseignementEtFormation =enseignementEtFormationService.findById(responsabilitePedagogique.getEnseignementEtFormation().getId());
...
private void associateResponsabilitePedagogiqueEnjeuxIrd(ResponsabilitePedagogique responsabilitePedagogique, List<ResponsabilitePedagogiqueEnjeuxIrd> responsabilitePedagogiqueEnjeuxIrd) {
...
private void associateResponsabilitePedagogiqueEtablissement(ResponsabilitePedagogique responsabilitePedagogique, List<ResponsabilitePedagogiqueEtablissement> responsabilitePedagogiqueEtablissement) {
    if (ListUtil.isNotEmpty(responsabilitePedagogiqueEtablissement)) {
        responsabilitePedagogiqueEtablissement.forEach(e -> e.setResponsabilitePedagogique(responsabilitePedagogique));
    }
    }
private void associateResponsabilitePedagogiquePays(ResponsabilitePedagogique responsabilitePedagogique, List<ResponsabilitePedagogiquePays> responsabilitePedagogiquePays) {
