...
import com.ird.faa.service.admin.facade.TypePubliqueRencontreMediaAdminService;
...
@Service
public class RencontreMediaAdminServiceImpl extends AbstractServiceImpl<RencontreMedia> implements RencontreMediaAdminService {

@Autowired
private RencontreMediaDao rencontreMediaDao;

        @Autowired
        private RencontreMediaPeriodeAdminService rencontreMediaPeriodeService ;
        @Autowired
        private EtatEtapeCampagneAdminService etatEtapeCampagneService ;
        @Autowired
        private PaysRencontreMediaAdminService paysRencontreMediaService ;
        @Autowired
        private RencontreMediaDisciplineScientifiqueAdminService rencontreMediaDisciplineScientifiqueService ;
        @Autowired
        private RencontreMediaEnjeuxIrdAdminService rencontreMediaEnjeuxIrdService ;
        @Autowired
        private TypePubliqueRencontreMediaAdminService typePubliqueRencontreMediaService ;
        @Autowired
