...
return findById(id);
     ...
     @Override
    public NiveauFormation archiver(NiveauFormation niveauFormation) {
        if (niveauFormation.getArchive() == null) {
        niveauFormation.setArchive(false);
        }
        niveauFormation.setArchive(true);
        niveauFormation.setDateArchivage(new Date());
        niveauFormationDao.save(niveauFormation);
        return niveauFormation;

    }

    @Override
    public NiveauFormation desarchiver(NiveauFormation niveauFormation) {
    if (niveauFormation.getArchive() == null) {
    niveauFormation.setArchive(false);
    }
    niveauFormation.setArchive(false);
    niveauFormation.setDateArchivage(null);
    niveauFormationDao.save(niveauFormation);
    return niveauFormation;
    }
