...
return findById(id);
     ...
     @Override
    public TemplateRelance archiver(TemplateRelance templateRelance) {
        if (templateRelance.getArchive() == null) {
        templateRelance.setArchive(false);
        }
        templateRelance.setArchive(true);
        templateRelance.setDateArchivage(new Date());
        templateRelanceDao.save(templateRelance);
        return templateRelance;

    }

    @Override
    public TemplateRelance desarchiver(TemplateRelance templateRelance) {
    if (templateRelance.getArchive() == null) {
    templateRelance.setArchive(false);
    }
    templateRelance.setArchive(false);
    templateRelance.setDateArchivage(null);
    templateRelanceDao.save(templateRelance);
    return templateRelance;
    }
...
if(templateRelance.getVisible() == null)
  templateRelance.setVisible(false);
    ...
    templateRelance.setAdmin(true);
    templateRelance.setVisible(true);
