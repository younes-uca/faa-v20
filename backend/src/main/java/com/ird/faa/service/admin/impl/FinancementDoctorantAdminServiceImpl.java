...
return findById(id);
     ...
     @Override
    public FinancementDoctorant archiver(FinancementDoctorant financementDoctorant) {
        if (financementDoctorant.getArchive() == null) {
        financementDoctorant.setArchive(false);
        }
        financementDoctorant.setArchive(true);
        financementDoctorant.setDateArchivage(new Date());
        financementDoctorantDao.save(financementDoctorant);
        return financementDoctorant;

    }

    @Override
    public FinancementDoctorant desarchiver(FinancementDoctorant financementDoctorant) {
    if (financementDoctorant.getArchive() == null) {
    financementDoctorant.setArchive(false);
    }
    financementDoctorant.setArchive(false);
    financementDoctorant.setDateArchivage(null);
    financementDoctorantDao.save(financementDoctorant);
    return financementDoctorant;
    }
