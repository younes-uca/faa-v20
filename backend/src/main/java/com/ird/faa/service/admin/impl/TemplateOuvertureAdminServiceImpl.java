...
return findById(id);
     ...
     @Override
    public TemplateOuverture archiver(TemplateOuverture templateOuverture) {
        if (templateOuverture.getArchive() == null) {
        templateOuverture.setArchive(false);
        }
        templateOuverture.setArchive(true);
        templateOuverture.setDateArchivage(new Date());
        templateOuvertureDao.save(templateOuverture);
        return templateOuverture;

    }

    @Override
    public TemplateOuverture desarchiver(TemplateOuverture templateOuverture) {
    if (templateOuverture.getArchive() == null) {
    templateOuverture.setArchive(false);
    }
    templateOuverture.setArchive(false);
    templateOuverture.setDateArchivage(null);
    templateOuvertureDao.save(templateOuverture);
    return templateOuverture;
    }
...
if(templateOuverture.getVisible() == null)
  templateOuverture.setVisible(false);
    ...
    templateOuverture.setAdmin(true);
    templateOuverture.setVisible(true);
