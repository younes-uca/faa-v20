...
return findById(id);
     ...
     @Override
    public NatureEtude archiver(NatureEtude natureEtude) {
        if (natureEtude.getArchive() == null) {
        natureEtude.setArchive(false);
        }
        natureEtude.setArchive(true);
        natureEtude.setDateArchivage(new Date());
        natureEtudeDao.save(natureEtude);
        return natureEtude;

    }

    @Override
    public NatureEtude desarchiver(NatureEtude natureEtude) {
    if (natureEtude.getArchive() == null) {
    natureEtude.setArchive(false);
    }
    natureEtude.setArchive(false);
    natureEtude.setDateArchivage(null);
    natureEtudeDao.save(natureEtude);
    return natureEtude;
    }
