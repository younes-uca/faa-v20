...
return findById(id);
     ...
     @Override
    public EtablissementProjet archiver(EtablissementProjet etablissementProjet) {
        if (etablissementProjet.getArchive() == null) {
        etablissementProjet.setArchive(false);
        }
        etablissementProjet.setArchive(true);
        etablissementProjet.setDateArchivage(new Date());
        etablissementProjetDao.save(etablissementProjet);
        return etablissementProjet;

    }

    @Override
    public EtablissementProjet desarchiver(EtablissementProjet etablissementProjet) {
    if (etablissementProjet.getArchive() == null) {
    etablissementProjet.setArchive(false);
    }
    etablissementProjet.setArchive(false);
    etablissementProjet.setDateArchivage(null);
    etablissementProjetDao.save(etablissementProjet);
    return etablissementProjet;
    }
