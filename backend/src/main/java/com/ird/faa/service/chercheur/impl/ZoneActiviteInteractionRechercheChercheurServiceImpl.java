...
import com.ird.faa.dao.ZoneActiviteInteractionRechercheDao;
...
String query = "SELECT o FROM ZoneActiviteInteractionRecherche o where 1=1 ";
    ...
    if(zoneActiviteInteractionRechercheVo.getZoneGeographiqueVo()!=null){
        query += SearchUtil.addConstraint( "o", "zoneGeographique.id","=",zoneActiviteInteractionRechercheVo.getZoneGeographiqueVo().getId());
            query += SearchUtil.addConstraint( "o", "zoneGeographique.code","LIKE",zoneActiviteInteractionRechercheVo.getZoneGeographiqueVo().getCode());
    }
...
return entityManager.createQuery(query).getResultList();
    ...
    private void findZoneGeographique(ZoneActiviteInteractionRecherche zoneActiviteInteractionRecherche){
        ZoneGeographique loadedZoneGeographique =zoneGeographiqueService.findByIdOrCode(zoneActiviteInteractionRecherche.getZoneGeographique());
