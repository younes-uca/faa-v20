...
import com.ird.faa.dao.EtablissementDao;
...
@Service
public class EtablissementChercheurServiceImpl extends AbstractServiceImpl<Etablissement> implements EtablissementChercheurService {
...
public List<Etablissement> findAll(){
    String query = "SELECT o FROM Etablissement o ";
...
if(foundedEtablissement==null) return null;
else{
...
public int delete(Etablissement etablissement){
    if(etablissement.getCode()==null) return -1;

    Etablissement foundedEtablissement = findByCode(etablissement.getCode());
    if(foundedEtablissement==null) return -1;
...
String query = "SELECT o FROM Etablissement o where 1=1 ";
        ...
        query += SearchUtil.addConstraintDate( "o", "dateCreation","=",etablissementVo.getDateCreation());
            ...
            query += SearchUtil.addConstraintMinMaxDate("o","dateArchivage",etablissementVo.getDateArchivageMin(),etablissementVo.getDateArchivageMax());
            query += SearchUtil.addConstraintMinMaxDate("o","dateCreation",etablissementVo.getDateCreationMin(),etablissementVo.getDateCreationMax());
