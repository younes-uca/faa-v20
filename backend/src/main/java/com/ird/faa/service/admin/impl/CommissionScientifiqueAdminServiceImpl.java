...
return findById(id);
     ...
     @Override
    public CommissionScientifique archiver(CommissionScientifique commissionScientifique) {
        if (commissionScientifique.getArchive() == null) {
        commissionScientifique.setArchive(false);
        }
        commissionScientifique.setArchive(true);
        commissionScientifique.setDateArchivage(new Date());
        commissionScientifiqueDao.save(commissionScientifique);
        return commissionScientifique;

    }

    @Override
    public CommissionScientifique desarchiver(CommissionScientifique commissionScientifique) {
    if (commissionScientifique.getArchive() == null) {
    commissionScientifique.setArchive(false);
    }
    commissionScientifique.setArchive(false);
    commissionScientifique.setDateArchivage(null);
    commissionScientifiqueDao.save(commissionScientifique);
    return commissionScientifique;
    }
