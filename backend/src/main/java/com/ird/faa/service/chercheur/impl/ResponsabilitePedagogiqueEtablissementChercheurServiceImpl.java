...
import com.ird.faa.dao.ResponsabilitePedagogiqueEtablissementDao;
...
@Service
public class ResponsabilitePedagogiqueEtablissementChercheurServiceImpl extends AbstractServiceImpl<ResponsabilitePedagogiqueEtablissement> implements ResponsabilitePedagogiqueEtablissementChercheurService {
...
@Override
public ResponsabilitePedagogiqueEtablissement update(ResponsabilitePedagogiqueEtablissement responsabilitePedagogiqueEtablissement){
ResponsabilitePedagogiqueEtablissement foundedResponsabilitePedagogiqueEtablissement = findById(responsabilitePedagogiqueEtablissement.getId());
if(foundedResponsabilitePedagogiqueEtablissement==null) return null;
else{
...
@Override
public ResponsabilitePedagogiqueEtablissement save (ResponsabilitePedagogiqueEtablissement responsabilitePedagogiqueEtablissement){
...
@Override
public List<ResponsabilitePedagogiqueEtablissement> save(List<ResponsabilitePedagogiqueEtablissement> responsabilitePedagogiqueEtablissements){
...
public int delete(ResponsabilitePedagogiqueEtablissement responsabilitePedagogiqueEtablissement){
    if(responsabilitePedagogiqueEtablissement.getId()==null) return -1;
    ResponsabilitePedagogiqueEtablissement foundedResponsabilitePedagogiqueEtablissement = findById(responsabilitePedagogiqueEtablissement.getId());
    if(foundedResponsabilitePedagogiqueEtablissement==null) return -1;
responsabilitePedagogiqueEtablissementDao.delete(foundedResponsabilitePedagogiqueEtablissement);
return 1;
}


public List<ResponsabilitePedagogiqueEtablissement> findByCriteria(ResponsabilitePedagogiqueEtablissementVo responsabilitePedagogiqueEtablissementVo){
...
String query = "SELECT o FROM ResponsabilitePedagogiqueEtablissement o where 1=1 ";
    ...
    if(responsabilitePedagogiqueEtablissementVo.getEtablissementVo()!=null){
        query += SearchUtil.addConstraint( "o", "etablissement.id","=",responsabilitePedagogiqueEtablissementVo.getEtablissementVo().getId());
            query += SearchUtil.addConstraint( "o", "etablissement.code","LIKE",responsabilitePedagogiqueEtablissementVo.getEtablissementVo().getCode());
    }

    if(responsabilitePedagogiqueEtablissementVo.getResponsabilitePedagogiqueVo()!=null){
        query += SearchUtil.addConstraint( "o", "responsabilitePedagogique.id","=",responsabilitePedagogiqueEtablissementVo.getResponsabilitePedagogiqueVo().getId());
    }

    if(responsabilitePedagogiqueEtablissementVo.getPaysVo()!=null){
        query += SearchUtil.addConstraint( "o", "pays.id","=",responsabilitePedagogiqueEtablissementVo.getPaysVo().getId());
            query += SearchUtil.addConstraint( "o", "pays.code","LIKE",responsabilitePedagogiqueEtablissementVo.getPaysVo().getCode());
    }
...
return entityManager.createQuery(query).getResultList();
    ...
    private void findEtablissement(ResponsabilitePedagogiqueEtablissement responsabilitePedagogiqueEtablissement){
        Etablissement loadedEtablissement =etablissementService.findByIdOrCode(responsabilitePedagogiqueEtablissement.getEtablissement());
    ...
    private void findResponsabilitePedagogique(ResponsabilitePedagogiqueEtablissement responsabilitePedagogiqueEtablissement){
        ResponsabilitePedagogique loadedResponsabilitePedagogique = null;
        if(responsabilitePedagogiqueEtablissement.getResponsabilitePedagogique() != null && responsabilitePedagogiqueEtablissement.getResponsabilitePedagogique().getId() !=null)
        loadedResponsabilitePedagogique =responsabilitePedagogiqueService.findById(responsabilitePedagogiqueEtablissement.getResponsabilitePedagogique().getId());
