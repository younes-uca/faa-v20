...
@Service
public class SavoirEtInnovationChercheurServiceImpl extends AbstractServiceImpl<SavoirEtInnovation> implements SavoirEtInnovationChercheurService {
...
@Override
public List<SavoirEtInnovation> findByChercheurUsernameAndCampagneId(String username, Long compagneId){
List<SavoirEtInnovation> resultat= savoirEtInnovationDao.findByChercheurUsernameAndCampagneId(username, compagneId);
    return resultat;
}
